...
def process_command_line(argv=None):
    ...
    # Create the parser
    arg_parser = argparse.ArgumentParser(prog='vaccine_clinic_model4',
                                        description='Run vaccine clinic simulation')

    # Add arguments
    arg_parser.add_argument("patient_arrival_rate", help="patients per hour",
                        type=float)

    arg_parser.add_argument("num_greeters", help="number of greeters",
                        type=int)  

    arg_parser.add_argument("num_reg_staff", help="number of registration staff",
                        type=int)

    arg_parser.add_argument("num_vaccinators", help="number of vaccinators",
                        type=int)                   

    arg_parser.add_argument("num_schedulers", help="number of schedulers",
                        type=int)

    parser.add_argument("--pct_need_second_dose", default=0.5, help="percent of patients needing 2nd dose (default = 0.5)",
                        type=float) 
