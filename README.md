...
------------
    ...
    │
    ├── setup.py           <- makes project pip installable (pip install -e .) so vaccine_clinic can be imported
    ├── src                <- Source code for use in this project.
    │   ├── vaccine_clinic <- Main package folder
    │   │   └── __init__.py    <- Marks as package
    │   │   └── vaccine_clinic.py  <- Just some placeholder Python source code file
    │
